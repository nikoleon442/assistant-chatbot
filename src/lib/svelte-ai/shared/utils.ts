import { type StreamPartType, StreamStringPrefixes, parseStreamPart } from './stream-parts';
...
function createChunkDecoder(complex: false): (chunk: Uint8Array | undefined) => string;
// complex decoder signature:
function createChunkDecoder(complex: true): (chunk: Uint8Array | undefined) => StreamPartType[];
