import type { AssistantMessage, DataMessage, FunctionCall, JSONValue, ToolCall } from './types';
import type { StreamString } from './utils';
...
const assistantMessageStreamPart: StreamPart<'4', 'assistant_message', AssistantMessage> = {
	code: '4',
...
const toolCallStreamPart: StreamPart<'7', 'tool_calls', { tool_calls: ToolCall[] }> = {
	code: '7',
	name: 'tool_calls',
	parse: (value: JSONValue) => {
		if (
...
const messageAnnotationsStreamPart: StreamPart<'8', 'message_annotations', Array<JSONValue>> = {
	code: '8',
